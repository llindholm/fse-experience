    ...
    <>
      ...
      <main>
        ...
        <section id="chapter-one" className="recognition-sequence"
          data-analytics-chapter="chapter-1"
          data-analytics-title="Chapter 1">
        ...
        <section id="chapter-two" className="authority-chapter"
          data-analytics-chapter="chapter-2"
          data-analytics-title="Chapter 2">
        ...
        <section id="chapter-three" className="identity-chapter"
          data-analytics-chapter="chapter-3"
          data-analytics-title="Chapter 3">
        ...
        <section id="chapter-four" className="demand-chapter"
          data-analytics-chapter="chapter-4"
          data-analytics-title="Chapter 4">
        ...
        <section id="chapter-five" className="engine-chapter"
          data-analytics-chapter="chapter-5"
          data-analytics-title="Chapter 5">
        ...
        <section id="chapter-six" className="possibility-chapter"
          data-analytics-chapter="chapter-6"
          data-analytics-title="Chapter 6">
        ...
        <section id="chapter-seven" className="inside-chapter"
          data-analytics-chapter="chapter-7"
          data-analytics-title="Chapter 7">
        ...
        <section id="chapter-eight" className="proof-chapter"
          data-analytics-chapter="chapter-8"
          data-analytics-title="Chapter 8">
        ...
        <section id="chapter-nine" className="invitation-chapter"
          data-analytics-chapter="chapter-9"
          data-analytics-title="Chapter 9">
          ...
          <section id="enrollment" className="offer-section">
            ...
            <Insight className="offer-content">
              ...
              <TrackedCheckoutLink
                ...
                ariaLabel="Enroll in Feminine Sales Engine"
          ...
          <section className="final-invitation">
            ...
            <Insight delay={0.24}>
              <TrackedCheckoutLink
                ...
                href="https://course.tolivingfree.com/fse-experience-checkout"
                ariaLabel="Join Feminine Sales Engine"
                source="final_invitation"
              >
